      ...
      <div className="container-custom">
        <div className="flex items-center justify-between h-20">
          ...
          <nav className="hidden md:flex items-center space-x-4 lg:space-x-6">
            ...
            >
              <SocialIcons delay={0.7} iconSize={16} className="mx-2" showAll={true} />
            </motion.div>
            <motion.div
              initial={{ opacity: 0, scale: 0.8 }}
              animate={{ opacity: 1, scale: 1 }}
            ...
            >
              <Button 
                ...
                onClick={() => window.open('https://vasanthakumar-jpg.github.io/portfolio-mui/images/Vasanthakumar.docx', '_blank')}
              >
            ...
            <nav className="container-custom py-6">
              <div className="flex flex-col space-y-4 items-center">
                ...
                <motion.div
                  ...
                  className="py-4"
                >
                  <SocialIcons delay={0.6} className="justify-center mb-4" showAll={true} />
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, x: -20 }}
                  animate={{ opacity: 1, x: 0 }}
