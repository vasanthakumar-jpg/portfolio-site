      ...
      <div className="container-custom" ref={ref}>
        ...
        <div className="mb-20">
          ...
          <div className="relative">
            {/* Timeline line */}
            <div className="absolute left-0 sm:left-8 md:left-1/2 top-0 bottom-0 w-0.5 bg-primary/30 transform md:-translate-x-0.5"></div>
            ...
            {experiences.map((exp, index) => (
              ...
              >
                {/* Timeline dot */}
                <div className="absolute -left-1.5 sm:left-8 md:left-1/2 w-4 h-4 bg-primary rounded-full transform md:-translate-x-2 z-10 border-4 border-background"></div>
                ...
                >
                  <div className="flex items-start flex-col lg:flex-row justify-between mb-4">
                    <div className="flex-1 min-w-0">
                      <h4 className="text-xl font-bold text-foreground text-left break-words">
                        {exp.title}
                      </h4>
                      <p className="text-primary font-semibold text-left break-words my-2 md:my-0">
                        {exp.company}
                      </p>
                    </div>
                  ...
                  <ul className="space-y-3">
                    {exp.achievements.map((achievement, i) => (
                      <li
                        key={i}
                        className="flex items-start text-sm text-muted-foreground text-left"
                      >
